        ...
        return (
            <div className="sidePanel">
                <div style={{ fontSize: 'large', fontWeight: 'bold' }}>Photo Provided by:<br />
                    <img className="photographerPic" src={this.props.authorObject.profile_image.large} alt='' />
                ...
                <SocialLinks author={this.props.authorObject.username} instagram={this.props.authorObject.instagram_username} twitter={this.props.authorObject.twitter_username} target="blank" />
            </div>
        )
    }
}
