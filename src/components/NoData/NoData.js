...
function NoData() {
    ...
    return (
        <div className="noDataDiv">
            ...
            <p />Help us fund increased API rate limits!<br /><br/>
            <p style={{fontSize:'small'}}>If this is the first time you're seeing this message, please wait a minute for the data feed to connect</p>
            <p /> 
